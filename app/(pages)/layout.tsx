  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={cn("bg-light text-dark", epilogue.variable, koulen.variable, geistMono.variable, pinyonScript.variable)}>
        ...
        <main className="container max-w-3xl px-4 pt-20 md:pt-28 pb-16 prose prose-theme prose-h1:text-3xl prose-h2:mb-2 prose-h3:text-lg prose-h3:mb-2 prose-code:text-xs">
          {children}
        </main>

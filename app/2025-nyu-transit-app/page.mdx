...
export const metadata = {
  ...
  description: "A mobile app that provides end-to-end trip planning for NYU's free shuttle system, replacing scattered schedules and a broken official app with a unified, route-aware navigator.",
  openGraph: {
    title: "University shuttle transit app",
    description: "A mobile app that provides end-to-end trip planning for NYU's free shuttle system, replacing scattered schedules and a broken official app with a unified, route-aware navigator.",
    images: [{ url: "/assets/thumbnails/nyutransitapp.png" }],
  },
  twitter: {
...
<Letterhead
  ...
  thumbnailAlt="Logo and mockups of the NYU Transit app concept"
  meta={[

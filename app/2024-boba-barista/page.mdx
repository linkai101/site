...
export const metadata = {
  ...
  description: "An original 3D character concept. Designed, modeled, and rigged in Maya.",
  openGraph: {
    title: "3D boba barista",
    description: "An original 3D character concept. Designed, modeled, and rigged in Maya.",
    images: [{ url: "/assets/thumbnails/bobabarista.png" }],
  },
  twitter: {
...
<Letterhead
  ...
  thumbnailAlt="Front and side view of a 3D boba barista character"
  meta={[
